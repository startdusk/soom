...
func init() {
	codegen.Register(codegen.Registration{
		Name:     "github.com/startdusk/soom/chat/Service",
		...
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return service_client_stub{stub: stub, createChatMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/startdusk/soom/chat/Service", Method: "CreateChat"}), getChatMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/startdusk/soom/chat/Service", Method: "GetChat"}), listChatMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/startdusk/soom/chat/Service", Method: "ListChat"}), deleteChatMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/startdusk/soom/chat/Service", Method: "DeleteChat"})}
		},
...
func (s service_local_stub) CreateChat(ctx context.Context, a0 string) (r0 Chat, err error) {
	...
	if span.SpanContext().IsValid() {
		...
		ctx, span = s.tracer.Start(ctx, "chat.Service.CreateChat", trace.WithSpanKind(trace.SpanKindInternal))
		defer func() {
			if err != nil {
...
func (s service_local_stub) GetChat(ctx context.Context, a0 string) (r0 Chat, err error) {
	...
	if span.SpanContext().IsValid() {
		// Create a child span for this method.
		ctx, span = s.tracer.Start(ctx, "chat.Service.GetChat", trace.WithSpanKind(trace.SpanKindInternal))
		defer func() {
			if err != nil {
				span.RecordError(err)
				span.SetStatus(codes.Error, err.Error())
...
func (s service_local_stub) ListChat(ctx context.Context) (r0 []Chat, err error) {
	...
	if span.SpanContext().IsValid() {
		// Create a child span for this method.
		ctx, span = s.tracer.Start(ctx, "chat.Service.ListChat", trace.WithSpanKind(trace.SpanKindInternal))
		defer func() {
			if err != nil {
				span.RecordError(err)
				span.SetStatus(codes.Error, err.Error())
...
func (s service_local_stub) DeleteChat(ctx context.Context, a0 string) (err error) {
	...
	if span.SpanContext().IsValid() {
		// Create a child span for this method.
		ctx, span = s.tracer.Start(ctx, "chat.Service.DeleteChat", trace.WithSpanKind(trace.SpanKindInternal))
		defer func() {
			if err != nil {
				span.RecordError(err)
				span.SetStatus(codes.Error, err.Error())
...
func (s service_client_stub) CreateChat(ctx context.Context, a0 string) (r0 Chat, err error) {
	...
	if span.SpanContext().IsValid() {
		// Create a child span for this method.
		ctx, span = s.stub.Tracer().Start(ctx, "chat.Service.CreateChat", trace.WithSpanKind(trace.SpanKindClient))
	}
...
func (s service_client_stub) GetChat(ctx context.Context, a0 string) (r0 Chat, err error) {
	...
	if span.SpanContext().IsValid() {
		// Create a child span for this method.
		ctx, span = s.stub.Tracer().Start(ctx, "chat.Service.GetChat", trace.WithSpanKind(trace.SpanKindClient))
	}
...
func (s service_client_stub) ListChat(ctx context.Context) (r0 []Chat, err error) {
	...
	if span.SpanContext().IsValid() {
		// Create a child span for this method.
		ctx, span = s.stub.Tracer().Start(ctx, "chat.Service.ListChat", trace.WithSpanKind(trace.SpanKindClient))
	}
	...
	// Decode the results.
	dec := codegen.NewDecoder(results)
	r0 = serviceweaver_dec_slice_Chat_39685b5c(dec)
	err = dec.Error()
	return
}
...
func (s service_client_stub) DeleteChat(ctx context.Context, a0 string) (err error) {
	...
	if span.SpanContext().IsValid() {
		// Create a child span for this method.
		ctx, span = s.stub.Tracer().Start(ctx, "chat.Service.DeleteChat", trace.WithSpanKind(trace.SpanKindClient))
	}
...
func (s service_server_stub) listChat(ctx context.Context, args []byte) (res []byte, err error) {
	...
	// Encode the results.
	enc := codegen.NewEncoder()
	serviceweaver_enc_slice_Chat_39685b5c(enc, r0)
	enc.Error(appErr)
	return enc.Data(), nil
}
...
func serviceweaver_enc_slice_Chat_39685b5c(enc *codegen.Encoder, arg []Chat) {
	if arg == nil {
		enc.Len(-1)
		return
	}
...
func serviceweaver_dec_slice_Chat_39685b5c(dec *codegen.Decoder) []Chat {
	n := dec.Len()
	if n == -1 {
		return nil
	}
